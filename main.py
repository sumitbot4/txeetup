...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text4 == '/d':
        ...
        cptoken = "yeseyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..dRcvcq8bKq2Dcl0ReS_8whNyfP-sRuMEQ5k9NlCoPYGjehFxGh3KyhiGZONLskN9"
        pwtoken = "pwtoken"
    else:
        cwtoken = raw_text4
        cptoken = raw_text4
